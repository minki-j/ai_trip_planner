        ...
        {role !== "ReasoningStep" && (
          <ReactMarkdown
            components={{
              ...
              h1: ({ children, ...props }) => (
                <h1 className="text-2xl font-bold mb-2 last:mb-0" {...props}>
                  {children}
                </h1>
              ),
              h2: ({ children, ...props }) => (
              ...
              blockquote: ({ children, ...props }) => (
                <blockquote
                  className="border-l-4 border-gray-300 pl-4 mb-2 last:mb-0"
                  {...props}
                >
                  {children}
                </blockquote>
              ...
              pre: ({ children, ...props }) => (
                <pre
                  className="bg-gray-100 rounded p-3 mb-2 last:mb-0 overflow-x-auto"
                  {...props}
                >
                  {children}
                </pre>
